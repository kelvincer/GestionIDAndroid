...
import com.eeec.GestionEspresso.util.AeSimpleSHA1;
...
public class KRegistrationIntentService extends IntentService {

    private static final String TAG = "RegIntentService";
    private static final String[] TOPICS = {"global"};

    public KRegistrationIntentService() {
        super(TAG);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            // You should store a boolean that indicates whether the generated token has bee
    ...
    private void sendRegistrationToServer(final String token) {
        final String key = "6720239";
        final String uname = "gestion";
        ...
        try {
            authString = AeSimpleSHA1.SHA1(uname + dateString + key);
        } catch (NoSuchAlgorithmException | UnsupportedEncodingException e) {
            return;
        }

        String url = Uri.parse("http://mobile.e3.pe/subscribe")
                .buildUpon()
                .appendQueryParameter("key", "val")
                .appendQueryParameter("channel", "appgestion")
                .appendQueryParameter("key", key)
                .appendQueryParameter("uname", uname)
                .appendQueryParameter("os", "android")
                .appendQueryParameter("date", dateString)
                .appendQueryParameter("token", token)
                .appendQueryParameter("auth_str", authString)
                .build().toString();

        Log.d("RIX_TRACE", "url:" + url);
...
//                LogUtil.d(error.toString());
                Log.e("RIX_TRACE", "errorUrlRegistration:" + error.getMessage());
            }
        });
    }
